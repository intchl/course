      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item active">
            <a href="../kursus-aktif/index.php" class="menu-link">
              <i class="menu-icon tf-icons bx bx-collection"></i>
              <div data-i18n="Basic">Data Kursur Aktif</div>
            </a>
          </li>
          <li class="menu-item ">
            <a href="../kursus/index.php" class="menu-link">
              <i class="menu-icon tf-icons bx bx-collection"></i>
              <div data-i18n="Basic">Data Kursus</div>
            </a>
          </li>
          <li class="menu-item ">
            <a href="../siswa/index.php" class="menu-link">
              <i class="menu-icon tf-icons bx bx-collection"></i>
              ...
              <div class="col-xl">
                <div class="card mb-4">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Tambah Data Kursus Aktif</h5>
                  </div>
                  <div class="card-body">
                    <form>
                      <div class="mb-3">
